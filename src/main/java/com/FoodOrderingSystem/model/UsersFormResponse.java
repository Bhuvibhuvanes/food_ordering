...
@Setter
@Data
public class UsersFormResponse {
	...
	public UsersFormResponse(int student_id, long rfid_Number, String first_name, String last_name, String department,
