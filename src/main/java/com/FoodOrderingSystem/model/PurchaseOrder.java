...
//    @JsonIgnore
    public UsersForm getStudentForm() {
        return studentForm;
    }
    ...
    public PurchaseOrder(int order_id, float quantity, int totalAmount, Date date_time, String status,
			UsersForm studentForm, List<FoodInventory> foodItems) {
		super();
		this.order_id = order_id;
		this.quantity = quantity;
		this.totalAmount = totalAmount;
    ...
    public void setStudentForm(UsersForm studentForm) {
        this.studentForm = studentForm;
    }
